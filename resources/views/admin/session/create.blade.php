      ...
      <div class="login-box-body">
        ...
        <form action="{{ URL::route('session.store') }}" method="post">
          <div class="form-group has-feedback @if($errors->has('email')) has-error @endif">
            <input type="email" name="email" class="form-control" placeholder="@lang('ems::forms.login.email.title')">
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              <button type="submit" class="btn btn-primary btn-block btn-flat">@lang('ems::forms.actions.login.title')</button>
            </div><!-- /.col -->
          </div>
        </form>
