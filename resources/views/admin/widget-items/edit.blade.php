<div class="widget-item-form" data-handle="{{ $handle }}" data-url="{{ URL::route('widgets.items.show-if-valid',[$widget->getTypeId()]) }}" data-type-id="{{ $widget->getTypeId() }}">
    ...
    <div class="modal-footer" id="overwritten-modal-footer">
        <button type="button" class="btn btn-primary" onclick="addWidget($(this).closest('.widget-item-form'))">{{ $addButtonText }}</button>
